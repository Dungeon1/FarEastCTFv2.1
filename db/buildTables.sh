...
sqlite3 fectf.db 'CREATE TABLE users (id INTEGER PRIMARY KEY, username TEXT NOT NULL, email TEXT, isAdmin BOOLEAN, isHidden BOOLEAN, password TEXT)';
...
sqlite3 fectf.db 'CREATE TABLE today_competition (id INTEGER PRIMARY KEY, header TEXT, image_name TEXT, text TEXT, buttom_name TEXT)';
